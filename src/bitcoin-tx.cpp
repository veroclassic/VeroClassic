...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Veroclassic Core veroclassic-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  veroclassic-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded veroclassic transaction") + "\n" +
              "  veroclassic-tx [options] -create [commands]   " + _("Create hex-encoded veroclassic transaction") + "\n" +
              "\n";
