    ...
    QWidget(0, f), curAlignment(0)
{
    ...
    //QString copyrightText1   = QChar(0xA9)+QString(" 2009-%1 ").arg(COPYRIGHT_YEAR) + QString(tr("The Veroclassic Core developers"));
    //QString copyrightText2   = QChar(0xA9)+QString(" %1 ").arg(COPYRIGHT_YEAR) + QString(tr("The Veroclassic Core developers"));
    ...
    pixPaint.setFont(QFont(font, 8*fontFactor));
    //pixPaint.drawText(pixmap.width()-paddingRightCopyright,paddingTop+paddingCopyrightTop,copyrightText2);
