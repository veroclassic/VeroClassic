...
std::string HelpMessageCli()
{
    ...
    strUsage += "  -rpcport=<port>        " + strprintf(_("Connect to JSON-RPC on <port> (default: %u or testnet: %u)"), 35154, 45154) + "\n";
    strUsage += "  -rpcwait               " + _("Wait for RPC server to start") + "\n";
    strUsage += "  -rpcuser=<user>        " + _("Username for JSON-RPC connections") + "\n";
    strUsage += "  -rpcpassword=<pw>      " + _("Password for JSON-RPC connections") + "\n";

    strUsage += "\n" + _("SSL options: (see the Veroclassic Wiki for SSL setup instructions)") + "\n";
...
static bool AppInitRPC(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help") || mapArgs.count("-version")) {
        ...
        if (!mapArgs.count("-version")) {
            strUsage += "\n" + _("Usage:") + "\n" +
                  "  veroclassic-cli [options] <command> [params]  " + _("Send command to Veroclassic Core") + "\n" +
                  "  veroclassic-cli [options] help                " + _("List commands") + "\n" +
                  "  veroclassic-cli [options] help <command>      " + _("Get help for a command") + "\n";
